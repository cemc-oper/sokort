from sokort.systems.cma_meso.graphics.meso_3km import Meso3kmPlotter
...
class Plotter(Meso3kmPlotter):
    ...
    def get_image_list(self):
        return [{
            "path": f"GRAPES-MESOS-prep-{self.start_time}3hr_{self.forecast_hour}_China.png"
        }]

    def _check_forecast_time(self) -> bool:
        forecast_hour = int(self.forecast_hour)
        return (forecast_hour != 0) and (forecast_hour % 3 == 0)
