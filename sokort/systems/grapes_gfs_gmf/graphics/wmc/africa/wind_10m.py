...
class AfricaWind10MPlotter(WmcPlotter):
    ...
    def __init__(self, task: dict, work_dir: str, config: dict, **kwargs):
        super(AfricaWind10MPlotter, self).__init__(task, work_dir, config, **kwargs)

        self.ncl_script_name = "africa_wind_10m.ncl"

    def get_image_list(self):
        forecast_hour = f"{get_forecast_hour(self.forecast_timedelta):03}"

        return [{
            "path": f"./ENG_NMC_NWPR_SGGRP_WIND_AFRICA_L10M_P9_{self.start_time}00{forecast_hour}00.png"
        }]
